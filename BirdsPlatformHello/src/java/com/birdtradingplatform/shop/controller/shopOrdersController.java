        ...
        try {
            ...
            if (session != null) {
                ...
                if (user != null) {
                    ...
                    List<OrderDetail> productNameList = detailDAO.getProductNameByOrderID();
                    Map<Integer, String> map = detailDAO.getMapImg();
                    Map<Integer, String> productNameMap = detailDAO.getProductNameMap();
                    request.setAttribute("PRODUCTNAME", productNameMap);
