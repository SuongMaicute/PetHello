                        ...
                        <div class="product-name">
                            ...
                            <div class="pick">
                                ...
                                <div class="quantity-wrap pick-fx">
                                    <c:set var="quan" value="1" ></c:set>
                                        <span class="spantt">Quantity </span>
                                        <div class="">
                                            <p class="minus">-</p>
                                        </div>
                                        <input type="number" name="quantity" max="${requestScope.productdetail.getQuantity()}" value="${pageScope.quan}"/>
                                    <div>
                                        <p class="add">+</p>
                                    </div>
        ...
        <section class="products">
            ...
            <c:if test="${requestScope.favouritedList!=null}">
                <c:if test="${not empty requestScope.favouritedList}">
                    ...
                    <h1 class="title"> <span>MOST FAVOURITED PRODUCTS OF THE SHOP</span> <a href="#">view all >></a> </h1>
