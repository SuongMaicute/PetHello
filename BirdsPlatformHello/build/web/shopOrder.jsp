                                    ...
                                    <table class="table">
                                        <thead class="table-thead">
                                            <tr>
                                                ...
                                                <th class="text-center" scope="col">Ship Date</th>
                                        ...
                                        <tbody>
                                            ...
                                            <c:set var="productNameList" value="${requestScope.PRODUCTNAME}"/>
                                                    ...
                                                    <tr>                    
                                                        ...
                                                        <td class="text-center">
                                                            <c:if test="${not empty productNameList}">
                                                                <c:forEach var="productEntry" items="${productNameList}">
                                                                    <c:if test="${productEntry.key eq order.orderID}">
                                                                        ${productEntry.value}
                                                                    </c:if>
                                                                </c:forEach>
                                                            </c:if>
