...
<html>
    ...
    <body>
                            ...
                            <div class="pick">
                                    ...
                                    <c:otherwise>
                                        <div class="transport pick-fx">
                                            ...
                                            <div class="transport-info">
                                                <div class="transport-to">
                                                    <img src="image/truck.png" alt="" />
                                                    <span>${requestScope.addressShipment}</span>
                                                </div>
                                                <div class="transport-price">
                                                    <span class="spantt">Transport fee </span>
                                                    <span>$5</span>
                                ...
                                <div class="quantity-wrap pick-fx">
                                    <c:set var="quantity" value="1" ></c:set>
                                        ...
                                        <input type="number" name="quantity" max="${requestScope.productdetail.getQuantity()}" value="${pageScope.quantity}"/>
                                    <div>
                                        <p class="add">+</p>
                                    </div>
                                ...
                                <div class="addtocart">
                                    <form action="cart">
                                        <div id="cart-btn" class="ri-shopping-cart-line">
                                            ...
                                            <input type="hidden" name="quantity" value="${pageScope.quantity}">
                ...
                <div class="shop-wrap">
                    <div class="shop-name seprate">
                        ...
                        <div class="shop-name__info">
                            ...
                            <div class="chat-shop">
                                <div class="">
                                    <img src="image/icons8-chat-50.png" alt="" />
                                    <span>Chat now</span>
                                </div>
                                <div class="">
                ...
                <div class="preview-wrap">
                    ...
                    <c:if test="${(requestScope.totalfeedback/requestScope.limit) >1}">
                        <div class="pagination">
                            <a href="product?action=detail&productID=${requestScope.productdetail.getProductID()}&page=${page-1}" class="prev">Previous</a>
                            ...
                            <a href="product?action=detail&productID=${requestScope.productdetail.getProductID()}&page=${page+1}" class="prev">Next</a>
        ...
        <section class="products">
            ...
            <h1 class="title"> <span>OTHER PRODUCTS OF THE SHOP</span> <a href="#">view all >></a> </h1>
